class ObsidianIndexLocal < Formula
  desc "A CLI tool for indexing Obsidian vaults (local test)"
  homepage "https://github.com/nzb3/obsidian-index"
  url "file:///Users/nikolay/Projects/Личные/obsidian-indexator"
  version "1.0.0"
  license "MIT"
  ...
  def install
    # Get git commit from the source directory
